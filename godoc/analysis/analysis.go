...
// error message.
//
package analysis // import "github.com/gophertrain/classroom/godoc/analysis"
...
import (
	...
	"github.com/gophertrain/classroom/go/pointer"
...
func Run(pta bool, result *Result) {
	...
	//args = []string{"github.com/gophertrain/classroom/cmd/godoc"}
	//args = []string{"fmt"}
