...
import (
	...
	"github.com/gophertrain/classroom/go/loader"
	"github.com/gophertrain/classroom/go/ssa"
	"github.com/gophertrain/classroom/go/ssa/interp"
	"github.com/gophertrain/classroom/go/ssa/ssautil"
)
...
func run(t *testing.T, dir, input string, success successPredicate) bool {
	...
	hint = fmt.Sprintf("To dump SSA representation, run:\n%% go build github.com/gophertrain/classroom/cmd/ssadump && ./ssadump -test -build=CFP %s\n", input)
	...
	hint = fmt.Sprintf("To trace execution, run:\n%% go build github.com/gophertrain/classroom/cmd/ssadump && ./ssadump -build=C -run --interp=T %s\n", input)
