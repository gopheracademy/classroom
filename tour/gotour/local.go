...
import (
	...
	"github.com/gophertrain/classroom/playground/socket"

	// Imports so that go build/install automatically installs them.
	_ "github.com/gophertrain/classroom/tour/pic"
	_ "github.com/gophertrain/classroom/tour/tree"
	_ "github.com/gophertrain/classroom/tour/wc"
)

const (
	basePkg    = "github.com/gophertrain/classroom/tour/"
	socketPath = "/socket"
)
...
func main() {
	...
	http.Handle("/content/videos/", static)
